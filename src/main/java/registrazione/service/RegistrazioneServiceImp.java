...
public class RegistrazioneServiceImp implements RegistrazioneService {
    ...
    /**
     * Implementa la funzionalità che implementa la registrazione dei dati anagrafici relativi all'account
     *
     * @param request oggetto della servlet, che contiene i parametri inviati e la sessione corrente
    ...
    /**
     * Implementa la funzionalità che implementa la registrazione dei dati relativi all'indirizzo
     *
     * @param request oggetto della servlet, che contiene i parametri inviati e la sessione corrente

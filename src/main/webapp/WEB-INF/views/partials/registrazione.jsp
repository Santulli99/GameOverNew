...
<div class="conteinerRegistrazione">
    ...
    <form id="form3"  name="modulo" onsubmit="return validateForm()" action="/GameOverNew_war_exploded/registrazione/controller/RegistrazioneServlet/registrazione" method="post">

...
<div class="conteinerLogin">
    <form class="form"  name="modulo"  onsubmit="return (validatePassword()&& confermaPassword())" action="${pageContext.request.contextPath}/GestioneUtenteController/updatePassword"  method="post">

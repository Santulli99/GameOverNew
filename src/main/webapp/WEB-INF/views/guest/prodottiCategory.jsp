    ...
    <section class="containerCenter" id="ajax">
        ...
        <div class="vetrina">
            <c:forEach items="${prodotti}" var="prodotto">
                ...
                <a href="${pageContext.request.contextPath}/GestioneProdottoController/showProduct?id=${prodotto.id}"> <img  src="${pageContext.request.contextPath}/cover/${prodotto.cover}">
                </a>

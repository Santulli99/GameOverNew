    ...
    <section class="containerCenter" id="ajax">
        ...
        <div class="generalProfilo">
           <div id="cliente"><p id="p1">Dati cliente:</p><p id="p2">${accountUtent.dataClient.firstName} ${accountUtent.dataClient.lastName}</p></div>
            ...
            <div>  <img src="/GameOver_war_exploded/icons/icons8-utente-60.png">
            </div>
            ...
            <div> <img src="/GameOver_war_exploded/icons/icons8-lucchetto.gif">
            </div>
            ...
            <div> <img src="/GameOver_war_exploded/icons/icons8-nuovo-messaggio-50.png">
            </div>
            ...
            <div>  <img src="/GameOver_war_exploded/icons/icons8-nome-utente-100.png">
            </div>
            <div class="sottodivPro1">
            ...
            <div><img src="/GameOver_war_exploded/icons/icons8-home-page-50.png"></div>
